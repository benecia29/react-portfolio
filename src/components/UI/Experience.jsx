    ...
    <section id="services" className="pb-11 pt-5 sm:pt-10">
      <div className="container">
        <div className="text-center">
          <h2 className="text-headingColor font-[800] text-[2.4rem] sm:mb-5 mb-0">
            ...
            <div className="relative text-gray-700 antialiased text-sm font-semibold">
              ...
              <div className="mt-6 sm:mt-0 sm:mb-12">
                <div className="flex items-center flex-col sm:flex-row">
                  <div className="flex justify-start w-full mx-auto items-center">
                    <div className="w-full sm:w-1/2 sm:pr-8">
                      ...
                      >
                        ...
                        <p className="text-[15px] text-smallTextColor group-hover:text-white group-hover:font-[500] leading-6 text-justify">
                  ...
                  <div className="rounded-full bg-primaryColor border-[#f0edff] border-4 w-10 h-10 absolute left-1/2 transform -translate-x-1/2 -translate-y-4 sm:translate-y-0 flex items-center justify-center">
