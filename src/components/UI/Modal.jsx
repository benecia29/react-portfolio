...
const Modal = ({ activeID, setShowModal }) => {
  ...
  return (
    <div className="overflow-auto w-full h-full fixed top-0 left-0 z-10 bg-headingColor bg-opacity-40">
      <div className=" w-11/12 md:max-w-[600px] md:w-full absolute sm:top-[75%] sm:left-[27%] left-4 top-[55%] z-20 bg-white rounded-[8px] transform-translate-x-1/2 -translate-y-1/2 p-5 ">
        <div>
          <figure>
        ...
        <div>
          ...
          <div className="mt-5 flex items-center gap-3 flex-wrap">
            <h4 className="text-headingColor text-[18px] trxt-[700]">
              Technologies:
            </h4>
